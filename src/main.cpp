...
void initialize() 
{
	...
	lv_style_copy(&btn1_pr, &lv_style_plain);
	btn1_pr.body.main_color = LV_COLOR_MAKE(127, 0, 0);
	btn1_pr.body.grad_color = LV_COLOR_MAKE(63, 0, 0);
	btn1_pr.body.radius = 1;
	btn1_pr.text.color = LV_COLOR_MAKE(255, 255, 255);
	...
	lv_style_copy(&btn2_pr, &lv_style_plain);
	...
	lv_style_copy(&btn3_pr, &lv_style_plain);
	btn1_pr.body.main_color = LV_COLOR_MAKE(127, 0, 0);
	...
	misctabbtn = lv_btn_create(misctab, NULL);
	...
	redstart1btn = lv_btn_create(redstart1btn, NULL);
	lv_obj_set_pos(redstart1btn, 20, 0);
	...
	redstart2btn = lv_btn_create(redstart2, NULL);
	lv_obj_set_pos(redstart2btn, 40, 0);
